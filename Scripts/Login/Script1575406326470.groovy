...
WebUI.setText(findTestObject('Login Page/Email Input', [('variable') : 'john.doe@johndoe.cl']), 'john.doe@johndoe.cl')

WebUI.setText(findTestObject('Login Page/Password Input', [('variable') : '123123']), '123123')
